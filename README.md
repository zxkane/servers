...
- **[Google Street View](https://github.com/mfukushim/map-traveler-mcp)** - Integrates Google Map, Google Street View, PixAI, Stability.ai, and Bluesky to provide a virtual location simulation in LLM (written in Effect.ts)
